...
echo "$i   <th class='column-2'>Weight</th>\n";
...
echo "$i   <td><select><option>20kg</option></select></td>\n";
echo "$i   <td><select><option>10</option></select></td>\n";
echo "$i   <td class='align-c done-td'><input type='checkbox'/></td>\n";
echo "$i   <td class='align-r time-td'>21:30:04</td>\n";
echo "$i  </tr>\n";
echo "$i  <tr>\n";
echo "$i   <td><select><option>Squats</option></select></td>\n";
echo "$i   <td><select><option>50kg</option></select></td>\n";
echo "$i   <td><select><option>5</option></select></td>\n";
echo "$i   <td class='align-c done-td'><input type='checkbox'/></td>\n";
